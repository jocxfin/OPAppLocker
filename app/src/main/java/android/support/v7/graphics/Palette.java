...
public final class Palette {
    ...
    public static final class Builder {
        ...
        private Bitmap scaleBitmapDown(Bitmap bitmap) {
            ...
            return Bitmap.createScaledBitmap(bitmap, (int) Math.ceil(((double) bitmap.getWidth()) * scaleRatio), (int) Math.ceil(((double) bitmap.getHeight()) * scaleRatio), Palette.LOG_TIMINGS);
        }
    }
    ...
    private Swatch findDominantSwatch() {
        int maxPop = ExploreByTouchHelper.INVALID_ID;
