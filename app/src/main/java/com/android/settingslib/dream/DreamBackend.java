...
public class DreamBackend {
    ...
    public DreamBackend(Context context) {
        ...
        this.mDreamsEnabledByDefault = context.getResources().getBoolean(17956975);
        this.mDreamsActivatedOnSleepByDefault = context.getResources().getBoolean(17956977);
        this.mDreamsActivatedOnDockByDefault = context.getResources().getBoolean(17956976);
    }
    ...
    private boolean getBoolean(String key, boolean def) {
        return Secure.getInt(this.mContext.getContentResolver(), key, def ? 1 : 0) == 1 ? true : DEBUG;
    }
